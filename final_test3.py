...
model_paths  = [
    ...
    './outputs_models/chinese-macbert-large_hard10_rand20_title_and_text_fixkeywords_alldata_ensemble1',
    './outputs_models/chinese-macbert-large_hard10_rand20_title_and_text_fixkeywords_alldata_ensemble2',
    './outputs_models/chinese-macbert-large_hard10_rand20_title_and_text_fixkeywords_alldata_ensemble3',

    './outputs_models/chinese-macbert-large_hard20_rand20_title_and_text_fixkeywords_alldata_ensemble1',
    './outputs_models/chinese-macbert-large_hard20_rand20_title_and_text_fixkeywords_alldata_ensemble2',
    './outputs_models/chinese-macbert-large_hard20_rand20_title_and_text_fixkeywords_alldata_ensemble3',
